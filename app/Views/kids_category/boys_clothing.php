...
<body>
    ...
    <main>
        <!-- bags start here -->
        <h1><center> Boys Clothes</center></h1>
        <div class="product-grid">
            <!-- Example Product Item Start -->
            <div class="product-item">
                <img src="<?php echo base_url('images1/kids/boys_clothes/cloth1.jpg');?>" alt="Product 1">
                <div class="product-details">
                    <h3 id="samani_1">Samani</h3>
                    <p id="boys_1">boys_clothes</p>
                    ...
                    <div class="container">
                        ...
                        function sendData() {
                                ...
                                var data2 = document.getElementById('boys_1').innerText;
                                var data3 = document.getElementById('price_1').innerText;
                            
                                window.location.href = "<?php echo site_url('addtocart'); ?>?data1=" + encodeURIComponent(data1)+"&data2="+ encodeURIComponent(data2)+"&data3="+ encodeURIComponent(data3)+"&data4="+encodeURIComponent('/images1/kids/boys_clothes/cloth1.jpg');
                            }
                        </script>
                    </div>
                </div>
            ...
            <div class="product-item">
                <img src="<?php echo base_url('images1/kids/boys_clothes/cloth2.jpg');?>" alt="Product 2">
                <div class="product-details"><br><br><br>
                    <h3 id="oke_2">oke brand</h3>
                    <p id="boys_2">boys_clothes</p>
                    ...
                    <div class="container">
                        ...
                        function sendData2() {
                                ...
                                var data2 = document.getElementById('boys_2').innerText;
                                var data3 = document.getElementById('price_2').innerText;
                            
                                window.location.href = "<?php echo site_url('addtocart'); ?>?data1=" + encodeURIComponent(data1)+"&data2="+ encodeURIComponent(data2)+"&data3="+ encodeURIComponent(data3)+"&data4="+encodeURIComponent('/images1/kids/boys_clothes/cloth2.jpg');
                            }
                        </script>
                    </div>
                </div>
            ...
            <div class="product-item">
                <img src="<?php echo base_url('images1/kids/boys_clothes/cloth3.jpg');?>" alt="Product 3">
                <div class="product-details"><br><br>
                    <h3 id="ahana_3">ahana brand</h3>
                    <p id="boys_3">boys_clothes</p>
                    ...
                    <div class="container">
                        ...
                        function sendData3() {
                                ...
                                var data2 = document.getElementById('boys_3').innerText;
                                var data3 = document.getElementById('price_3').innerText;
                            
                                window.location.href = "<?php echo site_url('addtocart'); ?>?data1=" + encodeURIComponent(data1)+"&data2="+ encodeURIComponent(data2)+"&data3="+ encodeURIComponent(data3)+"&data4="+encodeURIComponent('/images1/kids/boys_clothes/cloth3.jpg');
                            }
                        </script>
                    </div>
                </div>
            ...
            <div class="product-item">
                <img src="<?php echo base_url('images1/kids/boys_clothes/cloth4.jpg');?>" alt="Product 4">
                <div class="product-details"><br><br><br>
                    <h3 id="ahana_4">ahana brand</h3>
                    <p id="boys_4">boys_clothes</p>
                    ...
                    <div class="container">
                        ...
                        function sendData4() {
                                ...
                                var data2 = document.getElementById('boys_4').innerText;
                                var data3 = document.getElementById('price_4').innerText;
                            
                                window.location.href = "<?php echo site_url('addtocart'); ?>?data1=" + encodeURIComponent(data1)+"&data2="+ encodeURIComponent(data2)+"&data3="+ encodeURIComponent(data3)+"&data4="+encodeURIComponent('/images1/kids/boys_clothes/cloth4.jpg');
                            }
                        </script>
                    </div>
                </div>
            ...
            <div class="product-item">
                <img src="<?php echo base_url('images1/kids/boys_clothes/cloth5.jpg');?>" alt="Product 5">
                <div class="product-details">
                    <h3 id="ayush_5">ayush collection</h3>
                    <p id="boys_5">boys_clothes</p>
                    ...
                    <div class="container">
                        ...
                        function sendData5() {
                                ...
                                var data2 = document.getElementById('boys_5').innerText;
                                var data3 = document.getElementById('price_5').innerText;
                            
                                window.location.href = "<?php echo site_url('addtocart'); ?>?data1=" + encodeURIComponent(data1)+"&data2="+ encodeURIComponent(data2)+"&data3="+ encodeURIComponent(data3)+"&data4="+encodeURIComponent('/images1/kids/boys_clothes/cloth5.jpg');
                            }
                        </script>
                    </div>
                </div>
            ...
            <div class="product-item">
                <img src="<?php echo base_url('images1/kids/boys_clothes/cloth6.jpg');?>" alt="Product 6">
                <div class="product-details">
                    <h3 id="sandhya_6">sandhya collection</h3>
                    <p id="boys_6">boys_clothes</p>
                    ...
                    <div class="container">
                        ...
                        function sendData6() {
                                ...
                                var data2 = document.getElementById('boys_6').innerText;
                                var data3 = document.getElementById('price_6').innerText;
                            
                                window.location.href = "<?php echo site_url('addtocart'); ?>?data1=" + encodeURIComponent(data1)+"&data2="+ encodeURIComponent(data2)+"&data3="+ encodeURIComponent(data3)+"&data4="+encodeURIComponent('/images1/kids/boys_clothes/cloth6.jpg');
                            }
                        </script>
                    </div>
                </div>
            ...
            <div class="product-item">
                <img src="<?php echo base_url('images1/kids/boys_clothes/cloth7.jpg');?>" alt="Product 7">
                <div class="product-details">
                    <h3 id="ayush_7">ayush collection</h3>
                    <p id="boys_7">boys_clothes</p>
                    ...
                    <div class="container">
                        ...
                        function sendData7() {
                                ...
                                var data2 = document.getElementById('boys_7').innerText;
                                var data3 = document.getElementById('price_7').innerText;
                            
                                window.location.href = "<?php echo site_url('addtocart'); ?>?data1=" + encodeURIComponent(data1)+"&data2="+ encodeURIComponent(data2)+"&data3="+ encodeURIComponent(data3)+"&data4="+encodeURIComponent('/images1/kids/boys_clothes/cloth7.jpg');
                            }
                        </script>
                    </div>
                </div>
            ...
            <div class="product-item">
                <img src="<?php echo base_url('images1/kids/boys_clothes/cloth8.jpg');?>" alt="Product 8">
                <div class="product-details">
                    <h3 id="shreya_8">shreyas vv</h3>
                    <p id="boys_8">boys_clothes</p>
                    ...
                    <div class="container">
                        ...
                        function sendData8() {
                                ...
                                var data2 = document.getElementById('boys_8').innerText;
                                var data3 = document.getElementById('price_8').innerText;
                            
                                window.location.href = "<?php echo site_url('addtocart'); ?>?data1=" + encodeURIComponent(data1)+"&data2="+ encodeURIComponent(data2)+"&data3="+ encodeURIComponent(data3)+"&data4="+encodeURIComponent('/images1/kids/boys_clothes/cloth8.jpg');
                            }
                        </script>
                    </div>
                </div>
            ...
            <div class="product-item">
                <img src="<?php echo base_url('images1/kids/boys_clothes/cloth9.jpg')?>;" alt="Product 9">
                <div class="product-details">
                    <h3 id="shreya_9">shreya collection</h3>
                    <p id="boys_9">boys_clothes</p>
                    ...
                    <div class="container">
                        ...
                        function sendData9() {
                                ...
                                var data2 = document.getElementById('boys_9').innerText;
                                var data3 = document.getElementById('price_9').innerText;
                            
                                window.location.href = "<?php echo site_url('addtocart'); ?>?data1=" + encodeURIComponent(data1)+"&data2="+ encodeURIComponent(data2)+"&data3="+ encodeURIComponent(data3)+"&data4="+encodeURIComponent('/images1/kids/boys_clothes/cloth9.jpg');
                            }
                        </script>
                    </div>
                </div>
            ...
            <div class="product-item">
                <img src="<?php echo base_url('images1/kids/boys_clothes/cloth10.jpg');?>" alt="Product 10">
                <div class="product-details">
                    <h3 id="ayush_10">ayush collection</h3>
                    <p id="boys_10">boys_clothes</p>
                    ...
                    <div class="container">
                        ...
                        function sendData10() {
                                ...
                                var data2 = document.getElementById('boys_10').innerText;
                                var data3 = document.getElementById('price_10').innerText;
                            
                                window.location.href = "<?php echo site_url('addtocart'); ?>?data1=" + encodeURIComponent(data1)+"&data2="+ encodeURIComponent(data2)+"&data3="+ encodeURIComponent(data3)+"&data4="+encodeURIComponent('/images1/kids/boys_clothes/cloth10.jpg');
                            }
                        </script>
                    </div>
                </div>
            ...
            <div class="product-item">
                <img src="<?php echo base_url('images1/kids/boys_clothes/cloth11.jpg');?>" alt="Product 11">
                <div class="product-details">
                    <h3 id="riya_11">riya collection</h3>
                    <p id="boys_11">boys_clothes</p>
                    ...
                    <div class="container">
                        ...
                        function sendData11() {
                                ...
                                var data2 = document.getElementById('boys_11').innerText;
                                var data3 = document.getElementById('price_11').innerText;
                            
                                window.location.href = "<?php echo site_url('addtocart'); ?>?data1=" + encodeURIComponent(data1)+"&data2="+ encodeURIComponent(data2)+"&data3="+ encodeURIComponent(data3)+"&data4="+encodeURIComponent('/images1/kids/boys_clothes/cloth11.jpg');
                            }
                        </script>
                    </div>
                </div>
            ...
            <div class="product-item">
                <img src="<?php echo base_url('images1/kids/boys_clothes/cloth12.jpg');?>" alt="Product 12">
                <div class="product-details">
                    <h3 id="ayush_12">ayush collection</h3>
                    <p id="boys_12">boys_clothes</p>
                    ...
                    <div class="container">
                        ...
                        function sendData12() {
                                ...
                                var data2 = document.getElementById('boys_12').innerText;
                                var data3 = document.getElementById('price_12').innerText;
                            
                                window.location.href = "<?php echo site_url('addtocart'); ?>?data1=" + encodeURIComponent(data1)+"&data2="+ encodeURIComponent(data2)+"&data3="+ encodeURIComponent(data3)+"&data4="+encodeURIComponent('/images1/kids/boys_clothes/cloth12.jpg');
                            }
                        </script>
                    </div>
                </div>

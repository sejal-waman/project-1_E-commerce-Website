                    ...
                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col logo_section">
                        <div class="full">
                            <div class="center-desk">
                                <div class="logo">
                                    <a href="login_dashboard"><img src="<?php echo base_url('images/logo.jpeg');?>" alt="#" ></a>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="limit-box">
                                        <nav class="main-menu">
                                            <ul class="menu-area-main">
                                                <li class="active"> <a href="<?php echo base_url('login_dashboard');?>" class=" btn-outline-success">Home</a> </li>
                                               
                                                <li><a href="<?php echo base_url('register');?>" class=" btn-outline-success">Register</a></li>
                                               
                                                <li><a href="<?php echo base_url('login');?>" class=" btn-outline-success">Login</a></li>
        ...
        <div id="myCarousel" class="carousel slide banner-main" data-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <img class="second-slide" src="<?php echo base_url('images/background1.jpg');?>"  alt="Second slide">
                    <div class="container">
                        <div class="carousel-caption relative">
                            <h1 class="text-dark"></h1>
                            <span class="text-dark"></span>

                            <p class="text-dark">"BlissMart is an marketplace that brings<br>
                                joy and satisfaction to its customers,<br>
                ...
                <div class="carousel-item">
                    <img class="third-slide" src="<?php echo base_url('images/background2.jpg');?>" alt="Third slide">
                    <div class="container">
                        <div class="carousel-caption relative">
                            <h1 class="text-dark"></h1>
                            <span class="text-dark"></span>

                            <p class="text-dark">“Being more enthusiastic,<br>
                                more ethnic,<br>
        
                                more attractive with us” </p>

...
<head>
    ...
    <title>Lingerie & Loungewear</title>
...
<body>
    ...
    <main>
        <!-- bags start here -->
        <h1><center>Lingerie & Loungewear</center></h1>
        <div class="product-grid">
            <!-- Example Product Item Start -->
            <div class="product-item">
                <img src="<?php echo base_url('images1/women/lingerie/lingerie1.jpg');?>" alt="Product 1">
                <div class="product-details"><br><br><br>
                    <h3 id="samani_1">Samani</h3>
                    <p id="lingerie_1">lingerie</p>
                    ...
                    <div class="container">
                        ...
                        function sendData() {
                                ...
                                var data2 = document.getElementById('lingerie_1').innerText;
                                var data3 = document.getElementById('price_1').innerText;
                            
                                window.location.href = "<?php echo site_url('addtocart'); ?>?data1=" + encodeURIComponent(data1)+"&data2="+ encodeURIComponent(data2)+"&data3="+ encodeURIComponent(data3)+"&data4="+encodeURIComponent('/images1/women/lingerie/lingerie1.jpg');
                            }
                        </script>
            ...
            <div class="product-item">
                <img src="<?php echo base_url('images1/women/lingerie/lingerie2.jpg');?>" alt="Product 2">
                <div class="product-details"><br><br><br>
                    <h3 id="oke_2">oke brand</h3>
                    <p id="lingerie_2">lingerie</p>
                    ...
                    <div class="container">
                        ...
                        function sendData2() {
                                ...
                                var data2 = document.getElementById('lingerie_2').innerText;
                                var data3 = document.getElementById('price_2').innerText;
                            
                                window.location.href = "<?php echo site_url('addtocart'); ?>?data1=" + encodeURIComponent(data1)+"&data2="+ encodeURIComponent(data2)+"&data3="+ encodeURIComponent(data3)+"&data4="+encodeURIComponent('/images1/women/lingerie/lingerie2.jpg');
                            }
                        </script>
                    </div>
                </div>
            ...
            <div class="product-item">
                <img src="<?php echo base_url('images1/women/lingerie/lingerie3.jpg');?>" alt="Product 3">
                <div class="product-details"><br><br>
                    <h3 id="ahana_3">ahana brand</h3>
                    <p id="lingerie_3">lingerie</p>
                    ...
                    <div class="container">
                        ...
                        function sendData3() {
                                var data1 = document.getElementById('ahana_3').innerText;
                                var data2 = document.getElementById('lingerie_3').innerText;
                                var data3 = document.getElementById('price_3').innerText;
                            
                                window.location.href = "<?php echo site_url('addtocart'); ?>?data1=" + encodeURIComponent(data1)+"&data2="+ encodeURIComponent(data2)+"&data3="+ encodeURIComponent(data3)+"&data4="+encodeURIComponent('/images1/women/lingerie/lingerie3.jpg');
                            }
                        </script>
                    </div>
                </div>
            ...
            <div class="product-item">
                <img src="<?php echo base_url('images1/women/lingerie/lingerie4.jpg');?>" alt="Product 4">
                <div class="product-details"><br><br><br>
                    <h3 id="ahana_4">ahana brand</h3>
                    <p id="lingerie_4">lingerie</p>
                    ...
                    <div class="container">
                        ...
                        function sendData4() {
                                ...
                                var data2 = document.getElementById('lingerie_4').innerText;
                                var data3 = document.getElementById('price_4').innerText;
                            
                                window.location.href = "<?php echo site_url('addtocart'); ?>?data1=" + encodeURIComponent(data1)+"&data2="+ encodeURIComponent(data2)+"&data3="+ encodeURIComponent(data3)+"&data4="+encodeURIComponent('/images1/women/lingerie/lingerie4.jpg');
                            }
                        </script>
                    </div>
                </div>
            ...
            <div class="product-item">
                <img src="<?php echo base_url('images1/women/lingerie/lingerie5.jpg');?>" alt="Product 5">
                <div class="product-details">
                    <h3 id="ayush_5">ayush collection</h3>
                    <p id="lingerie_5">lingerie</p>
                    ...
                    <div class="container">
                        ...
                        function sendData5() {
                                ...
                                var data2 = document.getElementById('lingerie_5').innerText;
                                var data3 = document.getElementById('price_5').innerText;
                            
                                window.location.href = "<?php echo site_url('addtocart'); ?>?data1=" + encodeURIComponent(data1)+"&data2="+ encodeURIComponent(data2)+"&data3="+ encodeURIComponent(data3)+"&data4="+encodeURIComponent('/images1/women/lingerie/lingerie5.jpg');
                            }
                        </script>
                    </div>
                </div>
            ...
            <div class="product-item">
                <img src="<?php echo base_url('images1/women/lingerie/lingerie6.jpg');?>" alt="Product 6">
                <div class="product-details">
                    <h3 id="sandhya_6">sandhya collection</h3>
                    <p id="lingerie_6">lingerie</p>
                    ...
                    <div class="container">
                        ...
                        function sendData6() {
                                ...
                                var data2 = document.getElementById('lingerie_6').innerText;
                                var data3 = document.getElementById('price_6').innerText;
                            
                                window.location.href = "<?php echo site_url('addtocart'); ?>?data1=" + encodeURIComponent(data1)+"&data2="+ encodeURIComponent(data2)+"&data3="+ encodeURIComponent(data3)+"&data4="+encodeURIComponent('/images1/women/lingerie/lingerie6.jpg');
                            }
                        </script>
                    </div>
                </div>
            ...
            <div class="product-item">
                <img src="<?php echo base_url('images1/women/lingerie/lingerie7.jpg');?>" alt="Product 7">
                <div class="product-details">
                    <h3 id="ayush_7">ayush collection</h3>
                    <p id="lingerie_7">lingerie</p>
                    ...
                    <div class="container">
                        ...
                        function sendData7() {
                                ...
                                var data2 = document.getElementById('lingerie_7').innerText;
                                var data3 = document.getElementById('price_7').innerText;
                            
                                window.location.href = "<?php echo site_url('addtocart'); ?>?data1=" + encodeURIComponent(data1)+"&data2="+ encodeURIComponent(data2)+"&data3="+ encodeURIComponent(data3)+"&data4="+encodeURIComponent('/images1/women/lingerie/lingerie7.jpg');
                            }
                        </script>
                    </div>
                </div>
            ...
            <div class="product-item">
                <img src="<?php echo base_url('images1/women/lingerie/lingerie8.jpg');?>" alt="Product 8">
                <div class="product-details">
                    <h3 id="shreya_8">shreyas vv</h3>
                    <p id="lingerie_8">lingerie</p>
                    ...
                    <div class="container">
                        ...
                        function sendData8() {
                                ...
                                var data2 = document.getElementById('lingerie_8').innerText;
                                var data3 = document.getElementById('price_8').innerText;
                            
                                window.location.href = "<?php echo site_url('addtocart'); ?>?data1=" + encodeURIComponent(data1)+"&data2="+ encodeURIComponent(data2)+"&data3="+ encodeURIComponent(data3)+"&data4="+encodeURIComponent('/images1/women/lingerie/lingerie8.jpg');
                            }
                        </script>
                    </div>
                </div>
